...
const NETWORK_TYPE = 'TESTNET' as NetworkEnum; // process.env.REACT_APP_NETWORK_TYPE as NetworkEnum;
...
const TELEGRAM_BOT_ID = '7077363609'; // process.env.REACT_APP_TELEGRAM_BOT_ID;

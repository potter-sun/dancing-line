...
export const zkGuardianType = ["Apple", "Google"];
...
class OpenLogin {
  ...
  constructor(options: any) {
    ...
    // if (!options.sdkUrl) {
    //   if (options.customNetworkType === "local")
    //     options.sdkUrl = "http://localhost:3000";
    //   if (options.customNetworkType === "offline")
    //     options.sdkUrl = "WEB_PAGE_TEST";
    //   if (options.customNetworkType === "online")
    //     options.sdkUrl =
    //       options.networkType === "TESTNET" ? "WEB_PAGE_TESTNET" : "WEB_PAGE";
    // }
  ...
  //   // const res = Object.assign(result.data || {}, {
  //   //   nonce: zkNonce,
